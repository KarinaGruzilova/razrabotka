...
# text = [randint(0,100) for i in range(10)]
# print(sorted(text), min(text), max(text))

#Задача 4
# from random import randint
# sum=0
# text = [randint(0, 5) for i in range(10)]
# for i in text:
#     sum += i
# print("Список чисел-", *text,"Сумма -",sum)

#Лаба 4
#Задача 1
# from random import randint
# file = open('myfile.txt','w+')
# text=[randint(1,10) for i in range(10)]
# a = ''
# summa = 0
# for i in text:
#     a+= str(i) + ' '
...
# text2 = [randint(1,10) for i in range(10)]
# summa = 0
# с = ''
# for i in text2:
#     с+= str(i) + ' '
...
# errmsg = 'Error!'
# tk.Button(text='Выбрать файл', command=callback).pack(fill=tk.X)
# tk.mainloop()

# if name:
#     try:
#         with open(name, 'r') as file: 
#             fresult = [int(i) for i in file.read().split()]  
#             fsumma = sum(fresult)
#             fsrednee = fsumma / len(fresult)
#             print(fsrednee)
#     except FileNotFoundError:
#         print("Error: Файл не найден.")
#     except ValueError:
#         print("Error: Неверные данные в файле.  Пожалуйста, убедитесь, что в файле содержатся только числа, разделённые пробелами.")
...
#         Animals.anmls_count += 1  
  
#     def animals_count(self):  
#         print('Всего животных: %d' % Animals.anmls_count)
        
#     def display_animals(self):  
#         print('Животное: {}. Страна обитание: {}'.format(self.name, self.country))  
  
# anm1 = Animals("Тигр", "Азия")   
# anm2 = Animals("Пингвин", "Антарктида")  
# anm1.display_animals()  
# anm2.display_animals()  
# print("Всего животных: %d" % Animals.anmls_count)

# class Population(Animals):
#     def __init__(self, name, country, population):
#         super().__init__(name, country)
#         self.population = population

#     def pop_anm(self):
#         print(f"Популяция {self.name} в {self.country}: {self.population}")

# pop1 = Population("Тигр", "Азия", int(input("Введите популяцию тигров: ")))
# pop1.pop_anm()
